...
export const visaServices = [
  {
    ...
    description: {
      ...
      content: [
        ...
        {
          text: "This objective is achieved through selecting a broad mix of migrants on the basis of either their skills and experience or their family links to New Zealand.",
          type: "paragraph",
        },
        {
          text: "[R1] – INZ Operational Manual",
          type: "citation",
        },
      ],
    },
    categories: [
      {
        ...
        content:
          "Including Entrepreneur Residence Category, Employees of Relocating Businesses Category, Migrant Investment Categories, and Global Impact permanent resident visa for qualified professionals looking to contribute to New Zealand's business sector.",
      },
      {
        title: "Skilled Migrant Category",
        image: "/images/visa-services/service-2.jpg",
        content:
          "For skilled workers who can contribute to New Zealand's economic growth and development through their qualifications, work experience, and other relevant factors.",
      },
      {
        title: "Family Categories",
        image: "/images/visa-services/service-3.jpg",
        content:
          "Including Partnership Category, Parent Retirement Category, Parent Category, and Dependent Child Category for those with close family connections to New Zealand residents and citizens.",
      },
      {
        title: "Special Categories",
        image: "/images/visa-services/service-4.jpg",
        content:
          "Including Special Categories for certain nationalities (Pitcairn Islanders, Samoan Quota Scheme), Pacific Access Category, Refugee and Protection Category, and special provisions for victims of family violence and people trafficking.",
      },
      {
  ...
  },
  {
    ...
    description: {
      ...
      content: [
        ...
        {
          text: "Work visa instructions seek to achieve this by:",
          type: "paragraph",
        },
        {
          text: "1. facilitating the access of New Zealand employers and New Zealand industry to global skills and knowledge; while",
          type: "numbered",
        },
        {
          text: "2. complementing the Government's education, training, employment and economic development policies; and",
          type: "numbered",
        },
        {
          text: "3. ensuring that the employment in New Zealand of non-New Zealand citizens and residence class visa holders does not undermine the wages and conditions of New Zealand workers.",
          type: "numbered",
        },
        {
          text: "[W1] – INZ Operational Manual",
          type: "citation",
        },
      ],
    },
  ...
  },
  {
    ...
    description: {
      ...
      content: [
        ...
        {
          text: "facilitating the entry of genuine students, with a focus on attracting and developing students who have the skills and talent New Zealand needs; increasing global connectedness; supporting the sustainable growth of export education capability; earning foreign exchange; and strengthening New Zealand education",
          type: "paragraph",
        },
        {
          text: "[U1] – INZ Operational Manual",
          type: "citation",
        },
      ],
    },
  ...
  },
  {
    ...
    description: {
      ...
      content: [
        ...
        {
          text: "To foster tourism, trade and commerce, international understanding and cross-cultural links, educational and scientific activities, while:",
          type: "paragraph",
        },
        {
          text: "1: maintaining the health, safety and good order of New Zealand society; and",
          type: "numbered",
        },
        {
          text: "2: protecting New Zealand from international crime, terrorism and illegal immigration.",
          type: "numbered",
        },
        {
          text: "[V1] – INZ Operational Manual",
          type: "citation",
        },
      ],
    },
